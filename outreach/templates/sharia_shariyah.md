...
My name is Akbar Amirzoda, and I am the founder of AM Network (amnetwork.io) — 
a pre-launch blockchain-verified Zakat and Sadaqah platform.

About AM Network:
- Platform built on Base blockchain (Coinbase) with AI recipient scoring (0–100)
- Revenue model: Ujrah only (1–2.5% service fee on transactions)
- No speculative token — strict Sharia compliance from the start
- Target market: 2 billion Muslims globally, $600B annual Zakat obligation

I am seeking Sharia advisory services for:
1. Review and validation of our Ujrah-based business model
2. Sharia compliance assessment of AI recipient scoring methodology
3. Guidance on smart contract structure for Zakat distribution
4. Ongoing Sharia advisory support as we approach investors

I have reviewed your firm's focus on fintech startups and AAOIFI standards, 
and believe Shariyah Review Bureau would be the ideal partner for AM Network.

Could we schedule a brief introductory call at your earliest convenience?
